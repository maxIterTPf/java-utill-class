 ...
 * @version: 1.0
 */
public class ImageCompressionUtil_2 {
    /**
     * 实现图像的等比缩放
     *
     * @param source
...
//     boolean ret = false;
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream in = null;
        //缩放后的图片，保存路径
        File saveFile = new File("C:\\Users\\Seekcy&Joysuch\\Desktop\\ceshi111.jpg");
        try {
            //原图片的路径（需要压缩的图片的路径）
            in = new FileInputStream(new File("C:\\Users\\Seekcy&Joysuch\\Desktop\\ceshi.jpg"));
